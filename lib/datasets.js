...
function getData(datasetId) {
 ...
 function getStats(datasets) {
  ...
  datasets.forEach(dataset => {
    dataset.license === 'lov2' ? stats.license.lov2 += 1 : stats.license['odc-odbl'] += 1
    dataset.isValid ? stats.model['bal-aitf'] += 1 : stats.model.custom += 1
  })
...
module.exports = {getDatasets, getReport, getStats, getSummary, getCommune, getVoie}
